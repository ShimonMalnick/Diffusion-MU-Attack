...
if __name__ == "__main__":
    ...
    for ds_name in tqdm.tqdm(all_datasets_names, desc="Datasets"):
        for model_type in tqdm.tqdm(ModelType.get_all_types_names(), desc="Models"):
            command = f"python run_attack_benchmark.py --dataset_dir {base_dir}/{ds_name} --base_dir /home/shimon/research/Diffusion-MU-Attack --model_type {model_type}"
            print(command)
            os.system(command)