...
model_path = "/home/shimon/research/concepts_erasure_models/checkpoints/Baselines/localscratch/damon2024/DM_baselines/ALL_baseline_ckpt/nudity/UCE/UCE-Nudity-Diffusers-UNet.pt"
# import ipdb; ipdb.set_trace()
pipe.unet.load_state_dict(torch.load(model_path))
pipe.to(device)
SRC_IMAGE = image_path
RESULT_IMAGE_PATH = f"attack_output_{prompt.replace(' ', '')}.png"
