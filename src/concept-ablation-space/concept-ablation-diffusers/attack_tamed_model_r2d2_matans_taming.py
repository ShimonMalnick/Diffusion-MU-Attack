...
vae = pipe.vae
vae.load_state_dict(torch.load('../concept-ablation-space/models/matans_vae.pth'))
vae.to(device=device)

SRC_IMAGE = 'r2d2_generated_from_sd_v14.png'

SRC_IMAGE = 'matans_train_image.png'
RESULT_IMAGE_PATH = 'attack_r2d2_generated_from_sd_v14_matans_network_on_matans_train_image.png'
